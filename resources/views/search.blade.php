...
<section class="text-xl mx-32 my-14">
    <div class="flex flex-col items-center">
        <h2>Résultats</h2>
        <input class="mt-6 mb-1 p-4 bg-light-blue text-white rounded-2xl shadow-md hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75 cursor-pointer text-center" type="submit" value="Postuler à toutes les offres">
    </div>
    <div class="flex flex-wrap justify-center">
        <div class="w-2xl h-lg m-24 bg-light-blue"></div>
        <div class="w-2xl h-lg m-24 bg-light-blue"></div>
        <div class="w-2xl h-lg m-24 bg-light-blue"></div>
        <div class="w-2xl h-lg m-24 bg-light-blue"></div>
    </div>
