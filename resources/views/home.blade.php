...
@section('content')
  <div class="bg-primary block text-white p-24 pb-48">
  ...
  <article class="mt-36 ">
    ...
    <div class="flex my-5 justify-evenly">
      <div class="ml-24">
        <iframe width="750" class="h-full" src="https://www.youtube.com/watch?v=rcWzZz969qg&list=PLFHz2csJcgk8lgiRDB7FdsXVr4xy6jE8K&index=3"></iframe>
      </div>
      <div class="shadow-md bg-white rounded-lg ml-24 mr-24 p-10 relative">
        <div class="flex rounded-full bg-white shadow-md absolute translate-x-1/2 left-1/3 -top-24 w-sm h-sm ">
  ...
  <section class="flex mt-24">
    <div class="card shadow-md bg-white rounded-lg p-10 m-5 relative">
  ...
  <article class="bg-primary text-white m-36 p-10 flex flex-col justify-center place-items-center gap-8">
    <h3 class="text-4xl">Vous aimeriez voir votre entreprise sur notre site ?</h3>
    <p class="font-bold text-2xl">Créez votre page d'entreprise en appuyant simplement ici !</p><br>
    <a href="./job-created.blade.php" class="rounded-full border-2 border-white bg-white text-xl text-primary py-2 px-4 hover:text-white hover:bg-primary hover:border-2 hover:border-white transition duration-150 ease-out hover:ease-in">Page d'entreprise</a>
  </article>
