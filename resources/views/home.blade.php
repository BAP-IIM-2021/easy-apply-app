...
@section('content')
  ...
  <section class="xl:flex xl:flex-row xl:justify-evenly xl:mt-24 flex flex-col justify-center place-items-center">
    <div class="shadow-md bg-white rounded-lg p-10 m-5 relative w-lg my-14 ">
  ...
  <article class="bg-primary text-white text-center m-24 xl:m-36 p-10 flex flex-col justify-center place-items-center gap-8">
    ...
    <a href="" class="rounded-full border-2 border-white bg-white text-xl text-primary py-2 px-4 hover:text-white hover:bg-primary hover:border-2 hover:border-white transition duration-150 ease-out hover:ease-in">Page d'entreprise</a>
  </article>
