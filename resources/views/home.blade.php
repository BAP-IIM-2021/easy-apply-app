...
<article class="bg-primary text-white m-36 p-10 flex flex-col justify-center place-items-center gap-8">
  ...
  <a href="" class="rounded-full bg-white text-xl text-primary py-2 px-4 hover:text-white hover:bg-primary hover:border-2 hover:border-white">Page d'entreprise</a>
</article>
@endsection